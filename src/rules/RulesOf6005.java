...
public class RulesOf6005 {
     ...
     * @param implementationRequired  whether the assignment specifically asks you
     *                                to implement the feature in question.
    ...
    public static boolean mayUseCodeInAssignment(boolean writtenByYourself, boolean availableToOthers,
        ...
        if (implementationRequired && citingYourSource) {
            return true;
        }
